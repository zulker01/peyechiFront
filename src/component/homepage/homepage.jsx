...
function Home({token, userId, onBackToLogin, onSwitchToSignup}){
    ...
    if (currentView === 'found') return <CreateFoundItem token={token} userId={userId} onBack={() => setCurrentView('home')} />;
    if (currentView === 'lost') return <FoundItemsList token={token} onBack={() => setCurrentView('home')} onBackToLogin={onBackToLogin} />;
  ...
  <Row className="align-items-center text-center mb-5">
    <Col>
      ...
      <p className="lead mb-4">
        Quickly report lost items or browse items that have been found.
      </p>
      ...
      {/* <div className="d-flex justify-content-center gap-3 mt-3">
        <Button variant="danger" size="lg" onClick={() => setCurrentView('lost')}>
          Report Lost
        </Button>
    ...
    {/* <Col md={4} className="mb-6">
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            Quickly fill out details about your lost items and get notifications when they are found.
          </Card.Text>
          <Button variant="danger" onClick={() => setCurrentView('lost')}>Report Now</Button>
        </Card.Body>
      </Card>
    </Col> */}
    ...
    <Col md={4} className="mb-4">
      <Card>
        <Card.Body>
          ...
          <Button variant="success" onClick={() => setCurrentView('found')}>Browse</Button>
        </Card.Body>
      </Card>
    </Col>
    ...
    <Col md={4} className="mb-4">
      <Card>
        <Card.Body>
          ...
          <Card.Text>
            Register to get full access, report lost items, and track found items efficiently.
          </Card.Text>
